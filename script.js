// Список комплиментов
const compliments = [
    "Ваша улыбка озаряет этот мир!",
    "Вы самые прекрасные и удивительные!",
    "Ваши глаза — как звезды в ночи!",
    "Вы делаете каждый день особенным!",
    "Вы наша муза и вдохновение!",
    "Ваша красота затмевает весенние цветы!",
    "Вы — наша любимая загадка!",
    "С вами мир становится ярче!",
    "Ваш смех — лучшая мелодия!",
    "Вы — самое ценное в нашей жизни!",
    "Вы прекрасны во всех смыслах!",
    "Ваша душа чиста, как весеннее небо!",
    "Вы украшаете все вокруг своим присутствием!",
    "Ваши объятия — наш любимый уголок в мире!",
    "Вы делаете невозможное возможным!",
    "Вы наша любимая история!",
    "Вы восхитительны во всем!",
    "Ваша нежность покоряет наши сердца!",
    "Вы наша любимая причина для улыбки!",
    "Вы как весна — несёте тепло и радость!",
    "В поезде реально было кайфово с вами!!!",
    "Pov: Вечность бы гонял на поезде!"
];
...
const mediaData = [
    {
        ...
        comment: 'Тут мы впервые встретились! :)'
    },
    {
        type: 'video',
        src: 'images/video1.mp4',
        comment: 'Происходило много необычного и интересного! :)',
        muted: true
    },
    {
        type: 'image',
        src: 'images/photo2.jpg',
        comment: 'Наши интелектуальные диалоги!)'
    },
    {
        type: 'image',
        src: 'images/photo3.jpg',
        comment: 'Разговоры о непонятном!)'
    },
    {
        type: 'image',
        src: 'images/photo4.jpg',
        comment: 'Смех без причины!:)'
    },
    {
        type: 'image',
